...
module.exports = {
    ...
    async execute(interaction, client) {
       ...
       .setImage('https://media.discordapp.net/attachments/976860669926309970/1047565717584752680/2022-11-30_20.31.54.png')
        ...
        .addFields([
            {name: `<:wallet:1047085806696808538>  Гаманець`, value: `❯ \`/createwallet\` - **Створити AR гаманець**\n ❯ \`/balance\` - **Перевірити AR баланс**\n ❯ \`/arsend\` - **Надіслати AR**\n ❯ \`/ardrivesend\` - **Надіслати смарт-токен ArDrive**`, inline: true},
            {name: `<:dac:1047085787864379392>  Інше`, value: `❯ \`/help\` - **Список команд**\n ❯ \`/botinfo\` - **Про бота**\n ❯ \`/invite\` - **Корисні посилання**\n ❯ \`/arweave\` - **Про Arweave**`, inline: true}
        ])
        .setColor('#FF8747')
