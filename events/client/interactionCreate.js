    ...
    async execute(interaction, client) {
       ...
       let embedRuAr = new client.discord.EmbedBuilder()
        ...
        .addFields([
            ...
            {name: `**Что такое ArDrive?**`, value: `ArDrive — это не просто облачное хранилище. Это постоянное хранилище данных, а это означает, что любые файлы, которые вы загружаете в ArDrive, переживут вас! [Токены ArDrive](https://ardrive.io/what-are-ardrive-tokens/) не используются для оплаты загрузки ваших данных на ArDrive — для этого предназначен токен Arweave (AR). Вместо этого токены ArDrive имеют две основные цели: Вознаграждение: получение доли чаевых, полученных от всех транзакций ArDrive в сети. Для управления: возможность голосовать за стратегическое направление приложения и сообщества.`},
            {name: `**Что такое Another Money?**`, value: `Я так же хотел бы рассказать вам о [Another Money(ANO)](https://another.money), это первый по-настоящему децентрализованный, умный и дешевый токен для использования в смарт-контрактах SmartWeave и первый серьезный токен, не относящийся к PST, основанный на блокчейне arweave.`},
